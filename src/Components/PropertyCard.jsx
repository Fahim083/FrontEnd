              ...
              >
                ...
                <div className="flex flex-col flex-grow p-4">
                  ...
                  <div className="mt-auto flex items-center justify-between gap-2">
                    <Link to={`/property-details/${property._id}`} className="flex flex-1 items-center justify-center overflow-hidden rounded-lg h-9 px-4 bg-blue-500 font-semibold hover:bg-blue-600 text-white text-sm  hover:cursor-pointer"> 
                      <span className="truncate">View Details</span>
                    </Link>
                    <div className="flex gap-2">
                      <Link to={`/update-property/${property._id}`} className="flex items-center justify-center rounded-lg hover:cursor-pointer bg-gray-200 dark:bg-gray-200 h-9 w-9  hover:bg-gray-200 hover:dark:bg-gray-300 hover::bg-gray-300 ">
