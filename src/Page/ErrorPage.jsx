      ...
      <div className="layout-container flex h-full grow flex-col">
        <main className="flex flex-1 items-center justify-center py-10 sm:py-20">
          <div className="layout-content-container flex w-full max-w-xl flex-col items-center">
            ...
            {/* Error Code */}
            <h1 className="text-primary dark:text-white text-8xl font-black leading-tight text-center pb-3 pt-4">
              404
            </h1>
            ...
            <div className="flex flex-wrap justify-between gap-3 p-4 text-center">
              <div className="flex w-full flex-col items-center gap-3">
                ...
                <p className="text-[#6C757D] dark:text-gray-400 text-base font-normal leading-normal max-w-md">
            ...
            <div className="flex w-full max-w-sm px-4 py-3 justify-center">
              <button
                ...
                className="flex w-full min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-5 bg-primary text-white text-base font-bold leading-normal tracking-[0.015em] hover:bg-primary/90 transition-colors"
              >
